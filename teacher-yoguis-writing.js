// Auto-generated: moved inline scripts from teacher-yoguis-writing.html into external file to avoid inline-script blocking
(function(){
"use strict";
...
const $ = (s)=>document.querySelector(s);
  ...
  function start(){
    ...
    arr.unshift({
      ...
      updatedAt: now,
      messages: [
        { role:"system", text:"Escribe en inglés o español. Te responderé con correcciones y una pregunta para continuar." },
        { role:"assistant", text:`¡Listo! Tema: "${topic}".\n\nEmpieza con 2–3 frases. Yo te respondo con correcciones y una pregunta.` }
      ]
    });
